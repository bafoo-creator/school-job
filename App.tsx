...
const App: React.FC = () => {
  const [currentPage, setCurrentPage] = useState<'home' | 'contact' | 'post-job' | 'login'>('home');

  const navigateTo = (page: 'home' | 'contact' | 'post-job' | 'login') => {
    setCurrentPage(page);
      ...
      <main className="flex-grow">
        {currentPage === 'home' && (
          <>
            ...
            {/* Main Job Board Section (WP Job Manager Style) */}
            ...
            <section id="ecoles" className="py-24 bg-blue-600 text-white relative overflow-hidden">
              ...
              <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                ...
                <h2 className="text-4xl font-extrabold mb-6 italic text-white uppercase tracking-tighter">Espace Recruteurs</h2>
